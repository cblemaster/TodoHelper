...
public sealed class GenericRepository<T>(TodosDbContext context) : IRepository<T> where T : Entity<T>
{
    ...
    public void DisposeEntity(T entity) => _context.Entry(entity).State = EntityState.Detached;
}
